...
const ClassBadge = ({ name, color, bgColor }: { name: string; color: string; bgColor: string }) => (
    <span
            ...
            <section className="flex-1 flex flex-col items-center justify-center px-4 py-12 md:py-20 relative">
                ...
                <div className="relative z-10 text-center mb-8 md:mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
                    ...
                    <p className="text-sm text-foreground/60 max-w-md mx-auto">
                        Text-based RPG powered by AI where you solve DSA challenges to become a coding legend
                    </p>
                </div>
                ...
                <div className="relative z-10 mt-10 md:mt-16 grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500 w-full max-w-md md:max-w-2xl">
                    ...
                    <StatCard icon={Trophy} value="∞" label="Stories" color="text-green-400" />
                </div>
            </section>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-foreground/60 max-w-2xl mx-auto">
                            Alofy is a text-based RPG where every playthrough generates a unique story. Powered by AI,
                            your journey unfolds based on your choices and coding skills.
                        </p>
                    </div>
            ...
            <section className="px-4 py-12 md:py-20 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div className="p-6 bg-card border border-amber-500/20 rounded-lg">
                        ...
                        <div className="p-6 bg-card border border-green-500/20 rounded-lg">
                        ...
                        <div className="p-6 bg-card border border-blue-500/20 rounded-lg">
                    ...
                    <div className="text-center">
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-6 py-3 bg-amber-500/10 border border-amber-500/30 rounded-lg text-amber-400 font-bold text-xs uppercase tracking-wider hover:bg-amber-500/20 transition-all"
                        >
                            <Key size={16} />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        ...
                        <div className="space-y-6">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-foreground mb-1">Add Your API Key</h3>
                                    <p className="text-sm text-foreground/60">
                                        Get a free Gemini API key and add it to your profile
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-foreground mb-1">Create Your Character</h3>
                                    <p className="text-sm text-foreground/60">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-foreground mb-1">Embark on Your Journey</h3>
                                    <p className="text-sm text-foreground/60">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-foreground mb-1">Face the Hurdles</h3>
                                    <p className="text-sm text-foreground/60">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="font-bold text-green-400 mb-1">Claim Victory</h3>
                                    <p className="text-sm text-foreground/60">
                        ...
                        <div className="bg-card border border-border rounded-lg p-6">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    <h3 className="font-bold text-foreground">Choose Your Class</h3>
                                    <p className="text-xs text-foreground/50">Your coding language of choice</p>
                                </div>
                            </div>
                            <div className="flex flex-wrap gap-3 mb-6">
                                <ClassBadge name="Python" color="text-yellow-400" bgColor="bg-yellow-500/10" />
                                <ClassBadge name="Java" color="text-orange-400" bgColor="bg-orange-500/10" />
                                <ClassBadge name="C++" color="text-blue-400" bgColor="bg-blue-500/10" />
                            </div>
                            <p className="text-xs text-foreground/50">
                                Each class uses a different programming language to solve challenges. Pick the one you
                                want to master!
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        <div className="p-6 bg-card border border-red-500/20 rounded-lg text-center">
                            <div className="flex justify-center gap-1 mb-4">
                                {[1, 2, 3].map(i => (
                                    <Heart key={i} size={24} className="text-red-500 fill-red-500" />
                                ))}
                            </div>
                            <h3 className="font-bold text-red-400 mb-2">3 Hearts</h3>
                            <p className="text-xs text-foreground/60">
                                You start with 3 lives. Fail a hurdle and lose a heart. Lose all hearts and it&apos;s
                                game over.
                            </p>
                        </div>
                        ...
                        <div className="p-6 bg-card border border-yellow-500/20 rounded-lg text-center">
                            ...
                            <p className="text-xs text-foreground/60">
                                Boss battles at levels 3, 6, and 9. Each one tests your coding skills with DSA
                                challenges.
                            </p>
                        </div>
                        ...
                        <div className="p-6 bg-card border border-blue-500/20 rounded-lg text-center">
                            ...
                            <p className="text-xs text-foreground/60">
                                Journey through 10 unique levels, each with AI-generated story content and challenges.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="px-4 py-12 md:py-20 relative overflow-hidden">
                ...
                <div className="max-w-2xl mx-auto text-center relative z-10">
                    ...
                    <p className="text-foreground/60 mb-8">
                        Your unique adventure awaits. Create your character, face the challenges, and become a coding
                        legend.
                    </p>
                    <button
                        onClick={() => router.push("/menu")}
