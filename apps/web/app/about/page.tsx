            ...
            <div className="flex-1 px-4 py-8 overflow-y-auto">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center mb-16">
                        <div className="mb-6">
                            <GlitchText text="ALOFY" className="text-5xl md:text-6xl" />
                        </div>
                        <p className="text-xl text-accent font-bold tracking-wider mb-3">
                    ...
                    <section className="mb-16">
                        <h2 className="text-xl font-bold tracking-wide text-foreground mb-6 flex items-center gap-3">
                        ...
                        <div className="p-6 bg-card border border-border rounded-lg">
                            ...
                            <div className="flex gap-3">
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 px-4 py-2 bg-background border border-border rounded-lg text-foreground/70 font-bold text-xs uppercase tracking-wider hover:bg-card hover:border-accent/50 transition-all"
                                >
                                    <Github size={14} />
                                    <span>GitHub</span>
                                </a>
