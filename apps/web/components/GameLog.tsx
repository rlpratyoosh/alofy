            ...
            <div className="flex flex-col h-screen overflow-hidden font-mono">
                ...
                <div className="flex-1 flex items-center justify-center">
                    <div className="flex flex-col items-center gap-4 animate-in fade-in duration-500">
                        ...
                        <span className="text-sm tracking-widest text-foreground/70">LOADING GAME LOGS...</span>
                    </div>
                </div>
            </div>
        );
            ...
            <div className="flex-1 flex items-center justify-center p-3 md:p-4 overflow-auto">
                <div className="w-full max-w-3xl bg-card rounded-lg border border-border shadow-xl overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="p-4 md:p-6">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-accent/10 rounded-lg border border-accent/20">
                                    <Scroll size={18} className="text-accent md:w-5 md:h-5" />
                                </div>
                                <div>
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-card text-foreground text-xs font-bold uppercase tracking-wider rounded-lg hover:bg-indigo-950 transition-all duration-200 border border-border flex items-center gap-2 w-full sm:w-auto justify-center"
                            >
                                <ArrowLeft size={14} />
                                <span>Back</span>
                            </button>
                        ...
                        {/* Game List */}
                        <div className="space-y-3 max-h-[55vh] md:max-h-[60vh] overflow-y-auto scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent pr-1 md:pr-2">
                            {games.length === 0 ? (
                                <div className="text-center py-8 md:py-12 text-foreground/50 text-sm">
                                    <Gamepad2 size={36} className="mx-auto mb-3 md:mb-4 opacity-50 md:w-12 md:h-12" />
                                    <p className="font-bold tracking-wide">No games found</p>
                                    <p className="text-xs mt-2">Start a new adventure to see it here</p>
                                </div>
                            ) : (
                                games.map(game => (
                                    <button
                                        ...
                                        className="w-full p-3 md:p-4 bg-background border border-border rounded-lg hover:border-accent/50 hover:bg-accent/5 transition-all duration-200 text-left group"
                                    >
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3 md:gap-4 flex-1 min-w-0">
                                                {/* Character Avatar */}
                                                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-card border border-border flex items-center justify-center group-hover:border-accent/50 transition-colors shrink-0">
                                                    {game.character ? (
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-2 md:gap-4 mt-1">
                                                        <div className="flex items-center gap-1 md:gap-1.5 text-[10px] md:text-xs text-foreground/50">
                                                            <Trophy
                                                                size={10}
                                                                className="text-yellow-400 md:w-3 md:h-3"
                                                            />
                                                        ...
                                                        <div className="hidden sm:flex items-center gap-1 md:gap-1.5 text-[10px] md:text-xs text-foreground/40">
                                                            <Clock size={10} />
